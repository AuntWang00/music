  ...
  <body>
	...
	<div class="mymusic-contain">
		<div class="mymusic-list">
		     <a href="song/song_queryMyAllSongs?customer.customerid=<s:property 
			                  value='customerid'/>&customer.id=<s:property value='#session.customer.customerid'/>">我上传的音乐</a> 
	      ...
	      <div class="row">
	         <div class="col-md-12">
			    <s:form action="song/song_queryMyAllSongs" method="post">
